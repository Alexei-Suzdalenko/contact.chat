...
class MyFirebaseMessaging: FirebaseMessagingService() {
   ...
   //     }
    ...
    private fun sendNotificatioin(remoteMessage: RemoteMessage) {
        val intent = Intent(applicationContext, ChatConversationActivity::class.java)
    ...
    private fun sendOreoNotificatioin(remoteMessage: RemoteMessage) {
        ...
        val builder: Notification.Builder = oreoNotification.getOreoNotification(title,"Is Love App", pendingIntent, defaultSound,  R.mipmap.gaychat.toString()  )
